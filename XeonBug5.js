...
var xeonytimewisher = `Bonjour 🩵🌅`
 ...
 if(time2 < "11:00:00"){
var xeonytimewisher = `Bon réveil 🩵🌄`
 }
 if(time2 < "05:00:00"){
var xeonytimewisher = `Bon réveil 🩵🌄`
 } 
...
break
            ...
            case 'help':
            case 'alive':
                let xeonmenuoh = `╭══ *❍ 𝙹𝚎𝚊𝚗-𝙿𝚊𝚛𝚔𝚎𝚛-BUG_BOT ❍*
┃❁ *ᴏᴡɴᴇʀ:* 𝙹𝚎𝚊𝚗 𝙿𝚊𝚛𝚔𝚎𝚛
┃❁ *ᴜᴘᴛɪᴍᴇ:* ${runtime(process.uptime())}
┃❁ *User:* ${pushname}
╰┈➤ ${xeonytimewisher} 😄  My bro
⚠️⚠️ ~Don't forget to subscribe~ 
*𝙹𝚎𝚊𝚗 𝙿𝚊𝚛𝚔𝚎𝚛* ~whatsapp Channel~ ⚠️⚠️
_Any help: yt link https://chat.whatsapp.com/IAto4swnSi78hTHy9Rin61_
╰═════════════════⊷
╭═══❂ 𝗕𝗨𝗚 𝗠𝗘𝗡𝗨 ❂
┃ ❏ *xʀᴇᴀᴄᴛ <ʀᴇᴘʟʏ ᴄʜᴀᴛ>*
┃ ❏ *x <ɴᴜᴍʙᴇʀ|ᴀᴍᴏᴜɴᴛ>*
